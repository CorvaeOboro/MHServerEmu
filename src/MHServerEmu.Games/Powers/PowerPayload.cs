...
namespace MHServerEmu.Games.Powers
{
    ...
    /// </summary>
    public partial class PowerPayload : PowerEffectsPacket
    {
        ...
        private bool CalculateResultDamage(PowerResults results, WorldEntity target)
        {
            ...
            // Apply per-enemy incoming damage scale for incursion/calamity enemies.
            // Done after difficulty scaling so the multiplier is independent of tier normalization.
            ApplyIncursionIncomingDamageScale(results, target);
        ...
        // Incursion damage scaling methods are in PowerPayload.ModIncursionDamage.cs (partial class)
        ...
        private bool CalculateResultDamageDifficultyScaling(PowerResults results, WorldEntity target, out float difficultyMult)
        {
            ...
            // Normalize difficulty multiplier for IncursionEnemies (mod) - see PowerPayload.ModIncursionDamage.cs
            ApplyIncursionDifficultyNormalization(results, target);
