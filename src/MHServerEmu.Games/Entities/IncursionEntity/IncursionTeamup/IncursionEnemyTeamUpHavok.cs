...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Havok - rendered as the Havok Team-Up actor.
    /// Powers: 7 active / 11 total
    /// Damage scale per ability is listed below.
    /// </summary>
    public class IncursionEnemyTeamUpHavok : IncursionEnemyTeamup
    {
        private static readonly PrototypeId TeamUpRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/TeamUps/Havok.prototype");

        public IncursionEnemyTeamUpHavok(Game game) : base(game) { }

        public override PrototypeId RenderTeamupRef => TeamUpRef;
        public override string InvaderDisplayName => "Havok Invader";
