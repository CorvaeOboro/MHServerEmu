...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// IronManMark2 - rendered as the IronManMark2 Team-Up actor.
    /// Powers: 8 active / 11 total
    /// Damage scale per ability is listed below.
    /// </summary>
    public class IncursionEnemyTeamUpIronManMark2 : IncursionEnemyTeamup
    {
        private static readonly PrototypeId TeamUpRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/TeamUps/IronManMark2.prototype");

        public IncursionEnemyTeamUpIronManMark2(Game game) : base(game) { }
