...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// FirestarYellow - rendered as the FirestarYellow Team-Up actor.
    /// Powers: 7 active / 11 total
    /// Damage scale per ability is listed below.
    /// </summary>
    public class IncursionEnemyTeamUpFirestarYellow : IncursionEnemyTeamup
    {
        private static readonly PrototypeId TeamUpRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/TeamUps/FirestarYellow.prototype");

        public IncursionEnemyTeamUpFirestarYellow(Game game) : base(game) { }

        public override PrototypeId RenderTeamupRef => TeamUpRef;
        public override string InvaderDisplayName => "Firestar Yellow Invader";
        ...
        {
            new("Powers/TeamUps/Firestar/ChanneledBeam.prototype",  true,  0.026667f),  // Firestar/ChanneledBeam.prototype
            ...
            new("Powers/TeamUps/Firestar/ChanneledBeamDoTTrigger.prototype", false,  0.026667f),  // Firestar/ChanneledBeamDoTTrigger.prototype - trigger/secondary
            ...
            new("Powers/TeamUps/Firestar/Ultimate.prototype",  true, 0.013333f),  // Firestar/Ultimate.prototype - signature / ultimate
