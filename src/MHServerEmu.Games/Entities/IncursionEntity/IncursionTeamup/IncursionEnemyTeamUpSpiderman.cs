...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Spiderman - rendered as the Spiderman Team-Up actor.
    /// Powers: 7 active / 11 total
    /// Damage scale per ability is listed below.
    /// </summary>
    public class IncursionEnemyTeamUpSpiderman : IncursionEnemyTeamup
    {
        private static readonly PrototypeId TeamUpRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/TeamUps/Spiderman.prototype");

        public IncursionEnemyTeamUpSpiderman(Game game) : base(game) { }
        ...
        private static readonly IncursionPowerEntry[] _powerTable =
        {
            ...
            new("Powers/TeamUps/Spiderman/MaximumSpider.prototype",  true,  0.026667f),  // Spiderman/MaximumSpider.prototype
