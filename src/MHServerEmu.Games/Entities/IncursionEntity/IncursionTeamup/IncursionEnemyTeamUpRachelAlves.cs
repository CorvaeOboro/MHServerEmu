...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// RachelAlves - rendered as the RachelAlves Team-Up actor.
    /// Powers: 8 active / 11 total
    /// Damage scale per ability is listed below.
    /// </summary>
    public class IncursionEnemyTeamUpRachelAlves : IncursionEnemyTeamup
    {
        private static readonly PrototypeId TeamUpRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/TeamUps/RachelAlves.prototype");

        public IncursionEnemyTeamUpRachelAlves(Game game) : base(game) { }

        public override PrototypeId RenderTeamupRef => TeamUpRef;
        public override string InvaderDisplayName => "Rachel Alves Invader";
