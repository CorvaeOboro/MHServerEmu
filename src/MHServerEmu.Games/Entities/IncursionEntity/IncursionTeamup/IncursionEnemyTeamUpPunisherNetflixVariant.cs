...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// PunisherNetflixVariant - rendered as the PunisherNetflixVariant Team-Up actor.
    /// Powers: 8 active / 11 total
    /// Damage scale per ability is listed below.
    /// </summary>
    public class IncursionEnemyTeamUpPunisherNetflixVariant : IncursionEnemyTeamup
    {
        private static readonly PrototypeId TeamUpRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/TeamUps/PunisherNetflixVariant.prototype");

        public IncursionEnemyTeamUpPunisherNetflixVariant(Game game) : base(game) { }
