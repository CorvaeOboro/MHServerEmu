...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Wolverine - rendered as the Wolverine Team-Up actor.
    /// Powers: 8 active / 11 total
    /// Damage scale per ability is listed below.
    /// </summary>
    public class IncursionEnemyTeamUpWolverine : IncursionEnemyTeamup
    {
        private static readonly PrototypeId TeamUpRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/TeamUps/Wolverine.prototype");

        public IncursionEnemyTeamUpWolverine(Game game) : base(game) { }
        ...
        {
            new("Powers/TeamUps/WolverineBrood/CrimsonLeap.prototype",  true,  0.0344f), // 2026-07-30
            ...
            new("Powers/TeamUps/WolverineBrood/BloodySweep.prototype",  true,  0.0549f), // 2026-07-30
            new("Powers/TeamUps/WolverineBrood/BloodyClaws.prototype",  true,  0.023333f),  // WolverineBrood/BloodyClaws.prototype
            new("Powers/TeamUps/WolverineBrood/Eviscerate.prototype",  true,  0.0231f), // 2026-07-30
            new("Powers/TeamUps/WolverineBrood/EviscerateTrigger.prototype", false,  0.0231f), // 2026-07-30
            ...
            new("Powers/TeamUps/WolverineBrood/FuriousAssault.prototype",  true,  0.0215f), // 2026-07-30
