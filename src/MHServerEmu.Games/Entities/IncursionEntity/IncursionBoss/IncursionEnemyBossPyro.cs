...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Pyro - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossPyro : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/PyroBase.prototype");

        public IncursionEnemyBossPyro(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Pyro Invader";
