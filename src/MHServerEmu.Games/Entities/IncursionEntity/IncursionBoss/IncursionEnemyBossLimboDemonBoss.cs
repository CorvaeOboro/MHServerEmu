...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// LimboDemonBoss - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossLimboDemonBoss : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/Limbo/LimboEventLimboDemonBossIllusion.prototype");

        public IncursionEnemyBossLimboDemonBoss(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Limbo Demon Boss Invader";
