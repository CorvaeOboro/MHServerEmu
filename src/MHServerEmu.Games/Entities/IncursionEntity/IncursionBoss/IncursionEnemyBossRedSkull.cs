...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// RedSkull - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossRedSkull : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/RedSkullBase.prototype");

        public IncursionEnemyBossRedSkull(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Red Skull Invader";
