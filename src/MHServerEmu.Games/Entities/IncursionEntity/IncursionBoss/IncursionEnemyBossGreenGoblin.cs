...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// GreenGoblin - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossGreenGoblin : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/Story/GreenGoblinCH00.prototype");

        public IncursionEnemyBossGreenGoblin(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Green Goblin Invader";
