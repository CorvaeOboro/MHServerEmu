...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Brimstone - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossBrimstone : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/SurturRaid/Brimstone.prototype");

        public IncursionEnemyBossBrimstone(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Brimstone Invader";
