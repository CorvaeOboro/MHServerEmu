...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Sabretooth - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossSabretooth : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/PVEInstances/EG01Sabretooth.prototype");

        public IncursionEnemyBossSabretooth(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Sabretooth Invader";
