...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Shocker - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossShocker : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/ShockerBase.prototype");

        public IncursionEnemyBossShocker(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Shocker Invader";
