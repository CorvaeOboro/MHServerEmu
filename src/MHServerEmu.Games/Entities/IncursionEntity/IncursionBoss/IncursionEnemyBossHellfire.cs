...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Hellfire - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossHellfire : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/SurturRaid/Hellfire.prototype");

        public IncursionEnemyBossHellfire(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Hellfire Invader";
