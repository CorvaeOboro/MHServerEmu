...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Monolith - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossMonolith : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/SurturRaid/FiveMan/Monolith.prototype");

        public IncursionEnemyBossMonolith(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Monolith Invader";
