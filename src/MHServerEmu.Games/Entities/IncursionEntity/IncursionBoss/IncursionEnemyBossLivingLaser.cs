...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// LivingLaser - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossLivingLaser : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/LivingLaserBase.prototype");

        public IncursionEnemyBossLivingLaser(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Living Laser Invader";
