...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// MistressOfMagma - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossMistressOfMagma : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/SurturRaid/FiveMan/MistressOfMagma.prototype");

        public IncursionEnemyBossMistressOfMagma(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Mistress Of Magma Invader";
