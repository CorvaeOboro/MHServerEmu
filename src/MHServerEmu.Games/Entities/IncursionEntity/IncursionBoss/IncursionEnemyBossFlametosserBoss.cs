...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// FlametosserBoss - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossFlametosserBoss : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/Limbo/LimboEvent04LavaheartFlameTosserBoss.prototype");

        public IncursionEnemyBossFlametosserBoss(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Flametosser Boss Invader";
