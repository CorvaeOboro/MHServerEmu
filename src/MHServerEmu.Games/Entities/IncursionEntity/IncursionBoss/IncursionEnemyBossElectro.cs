...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Electro - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossElectro : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/ElectroBase.prototype");

        public IncursionEnemyBossElectro(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Electro Invader";
