...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// FireGiantBoss - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossFireGiantBoss : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/Limbo/LimboEvent01HeraldOfAshFireGiantBoss.prototype");

        public IncursionEnemyBossFireGiantBoss(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Fire Giant Boss Invader";
