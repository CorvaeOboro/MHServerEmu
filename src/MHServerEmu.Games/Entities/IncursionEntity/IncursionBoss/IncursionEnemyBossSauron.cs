...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Sauron - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossSauron : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/SauronBase.prototype");

        public IncursionEnemyBossSauron(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Sauron Invader";
