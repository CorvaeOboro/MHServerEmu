...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Rhino - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossRhino : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/RhinoBase.prototype");

        public IncursionEnemyBossRhino(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Rhino Invader";
