...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    /// Nastirh - spawned as the actual boss entity (no render override).
    ...
    /// </summary>
    public class IncursionEnemyBossNastirh : IncursionEnemyBoss
    {
        private static readonly PrototypeId BossRef =
            GameDatabase.GetPrototypeRefByName("Entity/Characters/Bosses/NAstirhBase.prototype");

        public IncursionEnemyBossNastirh(Game game) : base(game) { }

        public override PrototypeId RenderBossRef => BossRef;
        public override string InvaderDisplayName => "Nastirh Invader";
