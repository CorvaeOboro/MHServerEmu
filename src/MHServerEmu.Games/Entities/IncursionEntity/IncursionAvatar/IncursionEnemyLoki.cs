...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    public class IncursionEnemyLoki : IncursionEnemyAvatar
    {
        ...
        {
            new("Powers/Player/Loki/AsgardianLight.prototype",                    true,  0.0602f), // 2026-06-11
            new("Powers/Player/Loki/ChainBolt.prototype",                         true,  0.0992f), // 2026-06-11
            new("Powers/Player/Loki/ConeOfMagic.prototype",                       true,  0.0845f), // 2026-06-11
            new("Powers/Player/Loki/DecoyIllusion.prototype",                     true,  0.05f),
            new("Powers/Player/Loki/EternalFlame.prototype",                      true,  0.0968f), // 2026-06-11
            new("Powers/Player/Loki/GlacialSpike.prototype",                      true,  0.0689f), // 2026-06-11
            ...
            new("Powers/Player/Loki/IllusionRush.prototype",                      true,  0.1066f), // 2026-07-17
            new("Powers/Player/Loki/MagicChains.prototype",                       true,  0.0969f), // 2026-06-10
            new("Powers/Player/Loki/MagicCrush.prototype",                        true,  0.0904f), // 2026-06-10
            new("Powers/Player/Loki/MeddlingStrike.prototype",                    true,  0.1923f), // 2026-06-05
            new("Powers/Player/Loki/MindControl.prototype",                       true,  0.0681f), // 2026-07-17
            new("Powers/Player/Loki/SorcerousBlast.prototype",                    true,  0.1004f), // 2026-07-17
            new("Powers/Player/Loki/SpiritsOfTheDead.prototype",                  true,  0.0653f), // 2026-07-17
            new("Powers/Player/Loki/SwordSlice.prototype",                        true,  0.3103f), // 2026-06-05
            ...
            new("Powers/Player/Loki/Ultimate.prototype",                          true,  0.0038f), // 2026-06-11
            new("Powers/Player/Loki/UltimateHiddenPassive.prototype",             false, 0.0038f), // 2026-06-11
            new("Powers/Player/Loki/Unveiled.prototype",                          true,  0.0064f), // 2026-07-17
