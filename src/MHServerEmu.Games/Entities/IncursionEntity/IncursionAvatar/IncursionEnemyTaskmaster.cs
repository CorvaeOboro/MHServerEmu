...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    public class IncursionEnemyTaskmaster : IncursionEnemyAvatar
    {
        ...
        {
            new("Powers/Player/Taskmaster/BasicShot.prototype",                                true,  0.2235f), // 2026-06-11
            new("Powers/Player/Taskmaster/BasicShotTwo.prototype",                             true,  0.1903f), // 2026-06-11
            new("Powers/Player/Taskmaster/Cocoon.prototype",                                   true,  0.0740f), // 2026-06-11
            new("Powers/Player/Taskmaster/ConeYank.prototype",                                 true,  0.0322f), // 2026-06-11
            new("Powers/Player/Taskmaster/DisengagingShot.prototype",                          true,  0.0954f), // 2026-06-11
            new("Powers/Player/Taskmaster/FuriousLunge.prototype",                             true,  0.3288f), // 2026-06-11
            new("Powers/Player/Taskmaster/PoisonGasBomb.prototype",                            true,  0.1596f), // 2026-06-11
            new("Powers/Player/Taskmaster/ShieldBash.prototype",                               true,  0.0659f), // 2026-07-30
            new("Powers/Player/Taskmaster/ShieldBounce.prototype",                             true,  0.0763f), // 2026-06-11
            new("Powers/Player/Taskmaster/SteroidHotspot.prototype",                           true,  0.008f),
            new("Powers/Player/Taskmaster/SwingingAssault.prototype",                          true,  0.0371f), // 2026-06-11
            new("Powers/Player/Taskmaster/SwordStrike.prototype",                              true,  0.1508f), // 2026-06-11
            new("Powers/Player/Taskmaster/SwordStrikeTwo.prototype",                           true,  0.1339f), // 2026-06-11
            ...
            new("Powers/Player/Taskmaster/ThreeRoundBurst.prototype",                          true,  0.1770f), // 2026-06-11
            ...
            new("Powers/Player/Taskmaster/TripleStrike.prototype",                             true,  0.1672f), // 2026-06-11
            new("Powers/Player/Taskmaster/Ultimate.prototype",                                 true,  0.006f),
            new("Powers/Player/Taskmaster/Volley.prototype",                                   true,  0.1230f), // 2026-06-11
            new("Powers/Player/Taskmaster/WebSplat.prototype",                                 true,  0.1371f), // 2026-06-11
            new("Powers/Player/Taskmaster/WhirlingClub.prototype",                             true,  0.0188f), // 2026-07-17
            new("Powers/Player/Taskmaster/WidowsBite.prototype",                               true,  0.0541f), // 2026-06-11
