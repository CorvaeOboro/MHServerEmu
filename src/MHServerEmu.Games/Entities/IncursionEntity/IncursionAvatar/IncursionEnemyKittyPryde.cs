...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    public class IncursionEnemyKittyPryde : IncursionEnemyAvatar
    {
        ...
        {
            new("Powers/Player/KittyPryde/BasicMelee.prototype",                              true,  0.1919f), // 2026-06-10
            new("Powers/Player/KittyPryde/BuddySystem.prototype",                             true,  0.05f),
            new("Powers/Player/KittyPryde/DeathFromBelow.prototype",                          true,  0.0240f), // 2026-07-28
            new("Powers/Player/KittyPryde/Execute.prototype",                                 true,  0.0681f), // 2026-07-15
            new("Powers/Player/KittyPryde/HeartCrush.prototype",                              true,  0.0317f), // 2026-07-28
            new("Powers/Player/KittyPryde/LockheedChannelFire.prototype",                     true,  0.0190f), // 2026-06-10
            new("Powers/Player/KittyPryde/LockheedCharge.prototype",                          true,  0.0421f), // 2026-06-10
            new("Powers/Player/KittyPryde/LockheedFireBreath.prototype",                      true,  0.0514f), // 2026-06-10
            new("Powers/Player/KittyPryde/LockheedFireball.prototype",                        true,  0.1286f), // 2026-06-10
            ...
            new("Powers/Player/KittyPryde/PhaseAoE.prototype",                                true,  0.0136f), // 2026-06-10
            new("Powers/Player/KittyPryde/PhaseDash.prototype",                               true,  0.2447f), // 2026-06-08
            new("Powers/Player/KittyPryde/PhaseOut.prototype",                                true,  0.05f),
            new("Powers/Player/KittyPryde/PullUnderStart.prototype",                          true,  0.0215f), // 2026-07-15
            new("Powers/Player/KittyPryde/Signature.prototype",                               true,  0.0025f), // 2026-07-28
            new("Powers/Player/KittyPryde/TagTeam.prototype",                                 true,  0.0393f), // 2026-06-10
            ...
            new("Powers/Player/KittyPryde/Ultimate.prototype",                                true,  0.0132f), // 2026-07-28
