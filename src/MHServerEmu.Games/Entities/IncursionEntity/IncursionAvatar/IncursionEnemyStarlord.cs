...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    public class IncursionEnemyStarlord : IncursionEnemyAvatar
    {
        ...
        {
            new("Powers/Player/Starlord/Air.prototype",                                                true,  0.1754f), // 2026-06-10
            new("Powers/Player/Starlord/BasicEGun.prototype",                                          true,  0.1199f), // 2026-06-16
            new("Powers/Player/Starlord/Bulletspray.prototype",                                        true,  0.0380f), // 2026-06-10
            new("Powers/Player/Starlord/ChargedEGun.prototype",                                        true,  0.0426f), // 2026-06-07
            new("Powers/Player/Starlord/ClusterBomb.prototype",                                        true,  0.1628f), // 2026-06-10
            new("Powers/Player/Starlord/DisengagingShot.prototype",                                    true,  0.0971f), // 2026-06-07
            new("Powers/Player/Starlord/Earth.prototype",                                              true,  0.0592f), // 2026-06-10
            new("Powers/Player/Starlord/Fire.prototype",                                               true,  0.1363f), // 2026-06-10
            new("Powers/Player/Starlord/FreezeGrenade.prototype",                                      true,  0.0962f), // 2026-06-10
            new("Powers/Player/Starlord/GravityGrenade.prototype",                                     true,  0.1019f), // 2026-06-05
            new("Powers/Player/Starlord/Lunge.prototype",                                              true,  0.2710f), // 2026-06-10
            new("Powers/Player/Starlord/RapidEGun.prototype",                                          true,  0.3253f), // 2026-06-07
            new("Powers/Player/Starlord/SigOrbitalStrikeSummon.prototype",                             true,  0.02f),
            new("Powers/Player/Starlord/Strafe.prototype",                                             true,  0.0834f), // 2026-06-10
            ...
            new("Powers/Player/Starlord/UltCube.prototype",                                            true,  0.0121f), // 2026-06-18
            new("Powers/Player/Starlord/Water.prototype",                                              true,  0.0819f), // 2026-06-10
