...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    public class IncursionEnemyVision : IncursionEnemyAvatar
    {
        ...
        private static readonly IncursionPowerEntry[] _powerTable =
        {
            ...
            new("Powers/Player/Vision/AtomicFootDive.prototype",                          true,  0.0101f), // 2026-06-11
            new("Powers/Player/Vision/ControlRobot.prototype",                            true,  0.0410f), // 2026-06-11
            new("Powers/Player/Vision/ControlRobotHPassiveBuff.prototype",                false, 0.0410f), // 2026-06-11
            new("Powers/Player/Vision/DeathfromBelow.prototype",                          true,  0.0458f), // 2026-06-19
            ...
            new("Powers/Player/Vision/FocusBeam.prototype",                               true,  0.0230f), // 2026-06-11
            new("Powers/Player/Vision/HealingNanites.prototype",                          true,  0.05f),
            new("Powers/Player/Vision/ModeToggle.prototype",                              false, 0.05f),
            new("Powers/Player/Vision/Phase.prototype",                                   true,  0.0282f), // 2026-06-10
            new("Powers/Player/Vision/PhaseHand.prototype",                               true,  0.0282f), // 2026-06-10
            new("Powers/Player/Vision/PhasePunch.prototype",                              true,  0.2353f), // 2026-06-10
            new("Powers/Player/Vision/ScorchedEarth.prototype",                           true,  0.0384f), // 2026-06-11
            new("Powers/Player/Vision/SolarBolt.prototype",                               true,  0.3217f), // 2026-06-11
            new("Powers/Player/Vision/SolarChanneledEnergyBeam.prototype",                true,  0.1497f), // 2026-06-11
            new("Powers/Player/Vision/SolarCone.prototype",                               true,  0.0619f), // 2026-06-11
            new("Powers/Player/Vision/SolarOvercharge.prototype",                         true,  0.0148f), // 2026-06-11
            new("Powers/Player/Vision/SolarOverchargeHiddenPassive.prototype",            false, 0.0148f), // 2026-06-11
