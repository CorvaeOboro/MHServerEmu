...
namespace MHServerEmu.Games.Entities.IncursionEntity
{
    ...
    public class IncursionEnemyIronMan : IncursionEnemyAvatar
    {
        ...
        {
            new("Powers/Player/IronMan/BasicDentingPunch.prototype",                true,  0.1371f), // 2026-06-10
            new("Powers/Player/IronMan/BasicRepulsorBeam.prototype",                true,  0.1112f), // 2026-06-10
            new("Powers/Player/IronMan/BrutalStrike.prototype",                     true,  0.0401f), // 2026-07-01
            new("Powers/Player/IronMan/ChanneledEnergyBeam.prototype",              true,  0.0298f), // 2026-06-10
            new("Powers/Player/IronMan/DeathFromAbove.prototype",                   true,  0.0558f), // 2026-06-18
            new("Powers/Player/IronMan/FreonRay.prototype",                         true,  0.1124f), // 2026-06-10
            new("Powers/Player/IronMan/JetThrustPunch.prototype",                   true,  0.1906f), // 2026-06-10
            new("Powers/Player/IronMan/Micromissiles.prototype",                    true,  0.1286f), // 2026-06-10
            new("Powers/Player/IronMan/RainOfMissiles.prototype",                   true,  0.1011f), // 2026-06-10
            new("Powers/Player/IronMan/RapidFire.prototype",                        true,  0.3020f), // 2026-06-10
            new("Powers/Player/IronMan/RepulsorBurst.prototype",                    true,  0.2077f), // 2026-06-07
            new("Powers/Player/IronMan/RepulsorSpray.prototype",                    true,  0.0647f), // 2026-06-10
            new("Powers/Player/IronMan/ShieldOverload.prototype",                   true,  0.0396f), // 2026-07-01
            new("Powers/Player/IronMan/Signature.prototype",                        true,  0.0166f), // 2026-06-10
            new("Powers/Player/IronMan/SpeedRush.prototype",                        true,  0.2326f), // 2026-06-10
            ...
            new("Powers/Player/IronMan/UltimateSummonSuits.prototype",              true,  0.0647f), // 2026-06-10
            new("Powers/Player/IronMan/UniBeam.prototype",                          true,  0.05f),
            new("Powers/Player/IronMan/WristRocket.prototype",                      true,  0.1399f), // 2026-06-10
